            ...
            <div className="greetings">
                ...
                <div className="groupBio">
                    ...
                    <div className="descriptionBio">
                        ...
                        <p>Con questa ide nella testa, Paolo inizia a cercare la location perfetta per il suo B&B. Dopo un estenuante ricerca, finalmente trovò una vecchia costruzione localizzata nel cuore della città. E' stata abbandonata da diversi anni e aveva bisogno di diversi rinnovamenti, però Paolo ha visto il suo potenziale ed era pronto a darle nuova vita.</p>
